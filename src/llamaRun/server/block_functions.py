...
from llamaRun.data_structures import Handle, InferenceMetadata
from llamaRun.server.backend import TransformerBackend
from llamaRun.server.task_pool import PrioritizedTaskPool
from llamaRun.server.task_prioritizer import TaskPrioritizerBase
from llamaRun.utils.convert_block import QuantType
from llamaRun.utils.misc import DUMMY, is_dummy
from llamaRun.utils.packaging import unpack_args_kwargs
...
async def run_rpc_forward(
    *flat_tensors: torch.Tensor,
    ...
    for backend, prompt in zip(requested_backends, prompts):
        ...
        assert isinstance(backend.inference_pool, PrioritizedTaskPool), "llamaRun support only prioritized pools"
