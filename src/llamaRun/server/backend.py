...
from llamaRun.data_structures import InferenceMetadata
from llamaRun.server.memory_cache import MemoryCache
from llamaRun.server.task_pool import PrioritizedTaskPool
from llamaRun.utils.misc import get_size_in_bytes, is_dummy
...
class TransformerBackend(ModuleBackend):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        import llamaRun.utils.peft as _peft_module
