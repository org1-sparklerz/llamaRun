...
from llamaRun.client.config import ClientConfig
from llamaRun.client.routing.sequence_info import RemoteSequenceInfo
from llamaRun.client.routing.spending_policy import NoSpendingPolicy
from llamaRun.data_structures import ModuleUID, RemoteSpanInfo, ServerState
from llamaRun.server.handler import TransformerConnectionHandler
from llamaRun.utils.dht import get_remote_module_infos
...
class SequenceManagerConfig(ClientConfig):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "llamaRun.client.routing.SequenceManagerConfig has been moved to llamaRun.ClientConfig. "
...
class RemoteSequenceManager:
    ...
    def get_request_metadata(
        ...
        :param args_structure: the structure of flattened tensors from pack_args_kwargs in llamaRun.utils.packaging
